...
BEGIN
    ...
    SELECT  M.FK_COD_ESTUDIANTE_CI AS CODIGO, P.DNI, CONCAT(P.NOMBRE, ' ', P.APELLIDO_PAT, ' ', P.APELLIDO_MAT) AS NOMBRE, 
	CONCAT(I.NOM_IDIOMA, ' ',  L.NOM_NIVEL, ' ', C.CICLO) AS IDIOMA, PA.NOM_PERIODO, UPPER(MONTHNAME(PA.FECHA_INICIO)) AS MES, 
	...
	WHERE U.ID_USUARIO = P_ID_USUARIO AND M.FK_ID_ESTADO_MATRICULA = 4 AND 
    M.ID_MATRICULA = (SELECT MAX(ID_MATRICULA) FROM TPMATRICULA WHERE FK_COD_ESTUDIANTE_CI=V_COD_ESTUDIANTE);
END//
DELIMITER ;
